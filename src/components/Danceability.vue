      ...
      <div class="container mx-auto">
        ...
        <div class="xl:pl-130 lg:pl-96 md:pt-96 lg:pt-0">
          ...
          <div class="w-full pt-5">
            ...
            <p class="pt-1">Music and dance are tightly connected to each other, which leads to the question if we prefer dancy songs over others. On the plot you can see each of the 500 greatest songs represented as a dot. A higher danceability value means that this track is more suitable to dance to. Logged in users can see their own Top-20 tracks appear in the graph. Are you a dancer?</p>
          </div>
